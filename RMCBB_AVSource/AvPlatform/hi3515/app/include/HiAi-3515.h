/********************************************************
    ...
    Description:
********************************************************/
#ifndef __HIAI3515_H__
#define __HIAI3515_H__
...
public:
    ...
    int HiAi_ai_bind_aenc( ai_type_e eAiType, int phy_chn, int aencChn );
    int HiAi_ai_unbind_aenc( ai_type_e eAiType, int phy_chn, int aencChn );

/********************************************************
    ...
    Description:
********************************************************/
#ifndef __HIAVDEVICE_H__
#define __HIAVDEVICE_H__
#include "AvDevice.h"
#include "HiSystem.h"
#include "HiAvSysPicManager.h"
...
/////////////////////////////////////////////////	
    ...
    public:
        ...
        int Ad_start_ive_od(int phy_video_chn, unsigned char sensitivity);
        int Ad_stop_ive_od(int phy_video_chn);
        unsigned int Ad_get_ive_od_counter(int phy_video_chn);
        int Ad_reset_ive_od_counter(int phy_video_chn);
#endif
#endif
#if defined(_AV_PRODUCT_CLASS_IPC_)
...
/////////////////////////////////////////////////
    ...
    public:
        ...
        int Ad_start_ive();
        int Ad_stop_ive();
        int Ad_set_ive_osd(char * osd);
        int Ad_notify_bus_front_door_state(int state);

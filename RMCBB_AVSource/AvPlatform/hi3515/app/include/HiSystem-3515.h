/********************************************************
    ...
    Description:
********************************************************/
#ifndef __HISYSTEM3515_H__
#define __HISYSTEM3515_H__
...
class CHiSystem{
    ...
    private:
	 ...
	 int HiSys_get_vb_config_A5_II(unsigned int vi_num_sd, unsigned int vi_width_sd, unsigned int vi_hight_sd,VB_CONF_S *pvb_config);

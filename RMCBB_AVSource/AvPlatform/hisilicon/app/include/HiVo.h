...
class CHiVo{
    ...
    public:
		...
		int HiVo_bind_wbc(VO_WBC VoWbc, VO_WBC_SOURCE_S *pstWbcSource);
#endif
        int HiVo_start_wbc(VO_DEV source, VO_DEV destination, const VO_WBC_ATTR_S *pWbc_attr);
        ...
        int HiVo_set_dispos(VO_DEV vo_dev, int vo_chn, POINT_S pipPositon);
